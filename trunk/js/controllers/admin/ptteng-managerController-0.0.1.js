...
angular.module('admin')
    .controller('ManagerCtrl', ['$scope', '$rootScope', 'commonUtil', 'managerService','roleService',ManagerCtrl]);
        function ManagerCtrl( $scope, $rootScope, commonUtil, managerService,roleService) {
        var vm = $scope.vm = {};
        $scope.rid_role={};
        vm.roleList=[];
